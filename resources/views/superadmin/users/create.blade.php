<x-superadmin-layout>
    ...
    <div style="max-width: 600px; margin: 0 auto;">
        ...
        <div style="margin-bottom: 24px;">
            ...
            <div style="display:flex;align-items:center;gap:14px;">
                <div style="width:46px;height:46px;background:linear-gradient(135deg,#4f46e5,#7c3aed);border-radius:14px;display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:0 4px 12px rgba(124,58,237,.3);">
                    <iconify-icon icon="solar:user-plus-bold" style="font-size:22px;color:#fff;"></iconify-icon>
                </div>
                <div>
                    <h1 style="font-size:21px;font-weight:900;color:#0f172a;margin:0 0 3px;letter-spacing:-.02em;">Tambah Akun Siswa</h1>
        ...
        <div class="form-card" style="padding: 28px 28px 24px;">
            ...
            <form method="POST" action="{{ route('superadmin.users.store') }}" style="display:flex;flex-direction:column;gap:20px;">
                @csrf
                ...
                <div style="display:flex;gap:10px;align-items:center;">
                    <button type="submit" class="btn-primary">
                        <iconify-icon icon="solar:user-plus-bold" style="font-size:16px;"></iconify-icon>
                        Tambah Siswa
                    </button>
