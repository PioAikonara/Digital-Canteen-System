                ...
                <div class="section-card">
                    ...
                    <div style="margin-bottom:18px;">
                        ...
                        <div style="display:flex; gap:12px; flex-wrap:wrap;">
                            ...
                            <div class="cat-card {{ old('category') === $cat->name ? 'selected' : '' }}" onclick="selectCategory('{{ $cat->name }}', this)">
                                <iconify-icon icon="{{ $cat->icon }}" style="color:{{ old('category') === $cat->name ? 'var(--primary)' : 'var(--secondary)' }};"></iconify-icon>
